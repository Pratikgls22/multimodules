...
import com.ecommerce.ecom_essentials.configuration.ModalMapperConfig;
...
import com.ecommerce.ecom_essentials.service.RoleService;
...
public class RoleServiceImpl implements RoleService {
    ...
    public void addRole(RoleRequestDTO roleRequestDTO) {
        try {
            var user = this.roleRepository.findByRoleName(roleRequestDTO.getRoleName());
...
//    }
    ...
    @Override
    public RoleResponseDTO getById(String name) {
        try {
            var role = this.roleRepository.findByRoleName(name);
            if (role.isPresent()) {
